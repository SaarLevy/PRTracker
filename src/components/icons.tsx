...
export function DotsIcon({ size = 22 }: IconProps) {
  return (
...
export function BarbellIcon({ size = 22 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true">
      <path d="M2.5 12h2M19.5 12h2M8.5 12h7" />
      <rect x="4.5" y="7.5" width="2.4" height="9" rx="0.8" />
      <rect x="17.1" y="7.5" width="2.4" height="9" rx="0.8" />
      <rect x="7.6" y="5.5" width="2.4" height="13" rx="0.8" />
      <rect x="14" y="5.5" width="2.4" height="13" rx="0.8" />
    </svg>
  );
}
